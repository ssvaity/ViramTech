...
function Card({
  ...
  return (
    <motion.div
      ...
      className="mx-auto -mt-12 h-[30rem] w-full max-w-5xl rounded-[30px] border-4 border-[#6C6C6C] bg-[#222222] p-2 shadow-2xl md:h-[40rem] md:p-6 dark:border-[#3a3a3a]"
    >
      <div className="h-full w-full overflow-hidden rounded-2xl bg-gray-100 md:rounded-2xl dark:bg-zinc-900">
        {children}
      </div>
    </motion.div>
  );
